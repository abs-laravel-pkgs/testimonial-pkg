    ...
    controller: function($http, $location, HelperService, $scope, $routeParams, $rootScope, $location) {
        ...
        var dataTable = $('#testimonials_list').DataTable({
            ...
            stateLoadCallback: function(settings) {
                ...
                if (state_save_val) {
                    $('#search_testimonial').val(state_save_val.search.search);
                }
            ...
            scrollCollapse: true,
            ajax: {
                url: url(laravel_routes['getTestimonialList']),
                type: "GET",
                dataType: "json",
                data: function(d) {
                    d.testimonial_code = $('#testimonial_code').val();
                    d.testimonial_name = $('#testimonial_name').val();
            ...
            columns: [
                ...
                { data: 'code', name: 'testimonials.code' },
                { data: 'name', name: 'testimonials.name' },
                { data: 'mobile_no', name: 'testimonials.mobile_no' },
                { data: 'email', name: 'testimonials.email' },
            ],
...
app.component('testimonialForm', {
    ...
    controller: function($http, $location, HelperService, $scope, $routeParams, $rootScope) {
        get_form_data_url = typeof($routeParams.id) == 'undefined' ? testimonial_get_form_data_url : testimonial_get_form_data_url + '/' + $routeParams.id;
        var self = this;
        self.hasPermission = HelperService.hasPermission;
        ...
        $scope.onSelectedCountry = function(id) {
            testimonial_get_state_by_country = vendor_get_state_by_country;
            $http.post(
                testimonial_get_state_by_country, { 'country_id': id }
            ).then(function(response) {
                // console.log(response);
        ...
        $scope.onSelectedState = function(id) {
            testimonial_get_city_by_state = vendor_get_city_by_state
            $http.post(
                testimonial_get_city_by_state, { 'state_id': id }
            ).then(function(response) {
                // console.log(response);
